                                    ...
                                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 10; width: 100%; background-color:white;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= ucwords($row->from_city);?></td>
                                                <td><?= ucwords($row->destination_city);?></td>
                                                <td><?= $row->created_at;?></td>
                                                <td>


                                                    <div class="kt-demo-icon__overlay">
                                                        <a href="<?= base_url('seller/deletedeal/'.$row->id);?>" class="btn btn-sm btn-brand">
                                                            Delete
                                                        </a>
                                                        <a href="<?= base_url('seller/edit/'.$row->id);?>" class="btn btn-sm btn-brand">
                                                            Edit
                                                        </a>
                                                    </div>
